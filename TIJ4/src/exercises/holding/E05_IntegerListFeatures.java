...
/*
 * Be vigilant with overloaded methods like remove( ); it’s easy to make
 * mistakes due to autoboxing. If, for example, you type remove(2) instead of
 * remove(Integer.valueOf(2)) you remove the third element from the list (as the
 * first element’s index is 0), instead of an element whose value is 2.
 */